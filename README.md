...
| [Vue2 Build Info](./skills/vue2-build-info/) | Inject build environment and timestamp into index.html for Vue2 Webpack projects | "注入版本号" / "注入环境信息" / "构建信息" / "build info" | `<meta>` tags with buildEnv and buildTimestamp in index.html | 中文 · English |
